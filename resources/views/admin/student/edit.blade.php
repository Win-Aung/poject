...
@section('main-content')
 ...
 <form role="form" action="{{ route('students.update',$users->id) }}" method="post" enctype="multipart/form-data" >
        {{ csrf_field()}}
             @method('PUT')
      ...
      <strong>Student:Password</strong>
        ...
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          ...
          <div class="form-group col-md-12">
            ...
            <input type="text" name="address" class="form-control" placeholder="Phone" value="{{ $users->address }}">
